  ...
  <div class="home-c6">
    <div class="container">
      <div class="box_body">
        ...
        <h1 class="h1">
          <router-link :to="{ name: 'Dawarat' }">الدورات</router-link>
        </h1>
      </div>
      <div class="box_cards">
...
export default {
  ...
  methods: {
    transRight() {
      let Slides = document.querySelectorAll(".home-c6 .box_cards .card_body");
      this.count <= (this.Aldawarat.length - 3) * 321
        ? (this.count += 321)
        : this.count;
      Slides.forEach((e) => {
