    ...
    <div class="container">
      <div class="_body">
        <form action="#">
          <div class="name">
            <div class="label">
              <label for="first-name">الاسم المؤسسه</label>
          ...
          <div class="name">
            <div class="label">
              <label for="last-name">صفحة المؤسسه الرسميه</label>
              <i class="fa fa-star"></i>
            </div>
          ...
          <div class="name">
            <div class="label">
              <label for="linkedin">نبذه عن المؤسسه</label>
              <i class="fa fa-star"></i>
            </div>
          ...
          <div class="name">
            <div class="label">
              <label for="facebook">اترك رسالتك</label>
            </div>
          ...
          <div class="name">
            <div class="label">
              <label for="type">ما نوع المحتوى الذى سوف تقدمه ؟</label>
              <i class="fa fa-star"></i>
            </div>
